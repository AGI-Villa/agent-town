...
export function TownPageClient({ locale }: TownPageClientProps) {
        ...
        <>
          <nav className="absolute top-3 left-3 z-50 flex items-center gap-2 sm:gap-3 bg-black/60 backdrop-blur-sm rounded-lg px-2 sm:px-3 py-2 safe-area-top">
            <div className="flex gap-1.5 sm:gap-2">
              <a href="/" className="font-pixel text-[8px] sm:text-[9px] text-[#83769c] hover:text-white transition-colors touch-manipulation">{t('home')}</a>
              <span className="font-pixel text-[8px] sm:text-[9px] text-[#ffa300]">{t('town')}</span>
              <a href="/feed" className="font-pixel text-[8px] sm:text-[9px] text-[#83769c] hover:text-white transition-colors touch-manipulation">{t('feed')}</a>
              <a href="/timeline" className="font-pixel text-[8px] sm:text-[9px] text-[#83769c] hover:text-white transition-colors touch-manipulation">{t('timeline')}</a>
            </div>
